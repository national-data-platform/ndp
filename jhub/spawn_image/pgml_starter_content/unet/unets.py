...
def deconv(input_channels, output_channels,kernel_size):
    return nn.Sequential(
...
class U_net(nn.Module):
    def __init__(self, input_channels, output_channels, kernel_size, dropout_rate):
        ...
        self.deconv4 = deconv(1024, 256,3)
        self.deconv3 = deconv(768, 128,4)
        self.deconv2 = deconv(384, 64,3)
        self.deconv1 = deconv(192, 32,4)
        self.deconv0 = deconv(96, 16,4)
    ...
    def forward(self, x):
       ...
       # out = self.relu2(out + x[:,0,:,:].unsqueeze(1)) # Always Non-negative
        return out
